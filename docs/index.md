...
- **[Getting Started](getting-started/)** - Installation, quick start, prerequisites, and Docker setup
- **[User Guide](user-guide/)** - Core workflows, interactive creation, and validation
- **[CLI Tools](cli-tools/)** - Command-line tool reference and usage guides
- **[Features](features/)** - Advanced features: BDD patterns, variables, recovery, and more
- **[Development](development/)** - Contributing, testing, coverage, and CI/CD integration
- **[Examples](examples/)** - Real-world usage patterns and common workflows

🚀 **Quick Links:**

- [Quick Start Guide](getting-started/index.md) - Get up and running in minutes
- [Interactive Workflow](user-guide/interactive-workflow.md) - Step-by-step test case creation
- [test-verify Usage](cli-tools/test-verify-usage.md) - Verify test execution logs
- [Coverage Testing](development/coverage.md) - Code coverage guide
- [BDD Initial Conditions](features/bdd-initial-conditions.md) - Human-readable test conditions
...
- **Variables and Data Passing**: Capture dynamic values from command output and pass data between test steps using regex patterns and variable substitution. See [Variables and Data Passing Documentation](features/variable-passing.md) for details
...
See [getting-started/docker.md](getting-started/docker.md) for complete Docker documentation.
...
**Key Features**:
- **Variables and Data Passing**: Capture values from command output and pass data between test steps. See [Variables and Data Passing Documentation](features/variable-passing.md) for complete details on variable capture, substitution, and scope rules
...
**See Also**: [validate-yaml Quick Reference](cli-tools/validate-yaml.md) for comprehensive documentation and examples.
...
For complete documentation of all 23 patterns, parameter syntax, custom pattern creation, and best practices, see [BDD Initial Conditions Documentation](features/bdd-initial-conditions.md).
...
For more details, see [TTY Fallback Documentation](features/tty-fallback.md)
...
For detailed usage, see [Test Verify Usage Guide](cli-tools/test-verify-usage.md)
