...
7. [Container Format vs. Legacy Format](#container-format-vs-legacy-format)
...
>>>>>>> a1a68ae (Update report generation documentation to include container format flag and CLI options)
