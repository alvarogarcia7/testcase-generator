...
use testcase_models::{CaptureVar, CaptureVarsFormat, Expected, Step};
...
fn test_step_roundtrip_with_legacy_capture_vars() {
    ...
    let original = Step {
        ...
        verification: testcase_models::Verification {
            result: testcase_models::VerificationExpression::Simple("[[ $? -eq 0 ]]".to_string()),
            output: testcase_models::VerificationExpression::Simple(
