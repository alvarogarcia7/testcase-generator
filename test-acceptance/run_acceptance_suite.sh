...
# ============================================================================
#
# This script uses a numbered directory structure for organized test execution:
#
# 00_test_cases/              - Test case YAML files (input)
#                               Contains all test case definitions organized by category
#                               (success, failure, hooks, manual, variables, etc.)
#
# 05_scripts/                 - Generated executable bash scripts (Stage 2 output)
#                               Auto-generated from test case YAMLs by test-executor
#                               Includes hook lifecycle scripts in hooks/ subdirectory
#
# 10_test_results/            - Test execution results (Stage 3 output)
#     execution_logs/         - JSON execution logs from script runs
#
# 20_verification/            - Verification results (Stage 4 output)
#                               Container YAMLs generated by verifier tool
#                               Contains test results, metadata, and verification status
#
# 30_documentation_source/    - Generated documentation (Stage 6-7 output)
#     asciidoc/               - Individual AsciiDoc reports per test
#     markdown/               - Individual Markdown reports per test
#     consolidated/           - Unified documentation for all tests
#         all_tests_container.yaml  - Combined container for all test results
#         all_tests.adoc            - Consolidated AsciiDoc report
#         all_tests.md              - Consolidated Markdown report
#     acceptance_suite_execution.log - Detailed execution log
#     acceptance_suite_summary.txt   - Summary report of all stages
#
# BACKWARD COMPATIBILITY:
#   Symlinks provide compatibility with legacy directory names:
#   - test_cases → 00_test_cases
#   - scripts → 05_scripts
#   - execution_logs → 10_test_results/execution_logs
#   - verification_results → 20_verification
#   - reports → 30_documentation_source
#
# ============================================================================
...
# Paths - Using numbered directory structure
TEST_CASES_DIR="$SCRIPT_DIR/00_test_cases"
SCRIPTS_DIR="$SCRIPT_DIR/05_scripts"
TEST_RESULTS_DIR="$SCRIPT_DIR/10_test_results"
EXECUTION_LOGS_DIR="$TEST_RESULTS_DIR/execution_logs"
...
STAGES:
    1. Validation          Validate all test case YAMLs against schema (00_test_cases/)
    2. Generation          Generate bash scripts for all test cases (05_scripts/)
    3. Execution           Execute all automated test scripts (10_test_results/)
    4. Verification        Run verifier on execution logs (20_verification/)
    5. Container Validation Validate container YAMLs against schema (20_verification/)
    6. Documentation       Generate AsciiDoc and Markdown reports (30_documentation_source/)
    7. Consolidated Docs   Generate unified documentation for all tests (30_documentation_source/consolidated/)
