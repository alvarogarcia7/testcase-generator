...
RUN mkdir -p /root
COPY README_INSTALL_AUTOMATED.md /root
COPY README_INSTALL.md /root
RUN cat README_INSTALL.md README_INSTALL_AUTOMATED.md >> README_INSTALL_2.md && mv README_INSTALL_2.md README_INSTALL.md
